...
const CodeBlocks = ({
    ...
    return (
        <div className={`flex ${position} my-6 lg:my-20 justify-between gap-6 lg:gap-10  `}>
            ...
            <div className=' h-fit  flex flex-row  w-[100%] py-4 lg:w-[500px] bg-[rgba(77,74,74,0.15)]'>
